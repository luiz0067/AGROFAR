...
<script language="JavaScript">
  ...
  function verify(config){
		...
		msg += "Você não preencheu o campo Nome.\n";
	  ...
	  msg = "           CAMPO OBRIGATÓRIO         \n";
		msg += "_____________________________________\n\n";
		msg += "Você não preencheu o campo Sobrenome.\n";
		msg += "Este é uma campo Obrigatório\n\n";
		msg += "Você está sendo direcionado para o campo em branco a ser preenchido \n";
...
Set Conn = Server.CreateObject("ADODB.Connection")
   ...
   Sql="SELECT * from usuarios WHERE id =" & session("codigo")
   Rs.Open Sql, base_dados
   %>

<form  method="post" action="usuarios_perfil.asp?usuarios=atualizar&id=<%=session("codigo")%>" onSubmit="return verify(this)" name="config">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr  > 
            <td height="23" colspan="3" background="../imagens/forum_images/table_bg.gif"> 
              <center>
                ...
                Perfil do Usu&aacute;rio no Sistema ::</font> </strong> 
              </center></td>
          </tr>
          <tr> 
            ...
            <td colspan="2" bgcolor="#EEEEEE"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font> 
              <input name="nome" type="text"  class="text" id="nome" style="width:195px;" value="<%=Rs("nome")%>" > 
            </td>
          </tr>
          <tr> 
            ...
            <td colspan="2" bgcolor="#EEEEEE"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp; 
              <input name="sobrenome" type="text"  class="text" id="sobrenome" style="width:195px;" value="<%=Rs("sobrenome")%>">
              </font></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td width="41%" bgcolor="#EEEEEE">&nbsp; <strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FF0000"><%=session("acesso_escreve")%> 
              </font></strong> </td>
...
Conn.Close
   ...
   If Request.QueryString("usuarios") = "atualizar" Then
	...
	ENd If
	       ...
	       Sql="UPDATE  usuarios SET nome = '" & Request("nome") &  "', cidade = '" & Request("cidade") &  "', foto = '" & Request("foto") &  "', alert_msg = " & request("alert_msg") & ","
		   sql = sql + "estado = '" & Request("estado") &  "', endereco = '" & Request("endereco") &  "',"
		   sql = sql + "email = '" & Request("email") & "', sexo = '" & Request("sexo") & "', sobrenome = '" & Request("sobrenome") &  "',"
		   sql = sql + "senha = '" & Request("senha") & "', login = '" & Request("login") & "',niver = '" & Request("niver") & "',"

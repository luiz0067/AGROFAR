			...
			<table width="650" border="0" cellspacing="1" cellpadding="1" align="center" class="moldura1">
				<tr>
					<td height="21">
						...
						<p>
							<span class="f_vermelho_3_b">O arquivo é muito Pesado.</span><br>
							Desculpe mas o arquivo que voce está tentando enviar é muito pesado, o 
							<strong>máximo</strong> permitido é de<strong> 300 kb</strong>.<br>
							...
							<a href="http://media-convert.com" target="_blank" class="f_vermelho_1_b">http://media-convert.com</a> e converta seus arquivos online de maneira rápida e simples. <br>
				...
				<tr>
					<td height="21">
						...
						<p>
							...
							Desculpe mas o arquivo que voce está enviando nao é 
							um arquivo JPEG (<strong>.jpg</strong>) é um arquivo (<strong><%=FExtension%></strong>).<br />
							...
							e converta seus arquivos online de maneira rápida e simples. <br>
							<img src="../imagens/icos_e_fundos/question.png" alt="Ajuda" width="16" height="16" align="absmiddle"> 
							O tamanho que usamos é de <span style="font-weight:bold">largura</span> (Width) = 

...
<div align="center"> <font color="<%=cor_links%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">[<a href="produtos_default.asp">voltar 
  para página de Produtos</a>]</font><br>
  <%
If request("ac") = "editar" Then

	Set Rs = Server.CreateObject("ADODB.Recordset")
	Sqltext = "SELECT * FROM produtos WHERE id = " & request("id") & ""
	Rs.Open SqlText, base_dados
	Session("texto") = Rs("conteudo")
	titulo = RS("titulo")
	subtitulo= Rs("subtitulo")
	tit_menu =rs("tit_menu")
	Rs.Close
	Set Rs = Nothing
	End If
	%>
  <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong> </strong></font> </div>
<FORM METHOD="post" ACTION="produtos_editar.asp?ac=<%=request("ac")%>" onSubmit="return CheckForm();" name="frmSendmail">
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF"  >
          <tr> 
            <td background="../imagens/forum_images/table_bg2.gif"><div align="center"><font color="#336699" size="2" face="Arial, Helvetica, sans-serif"><strong>Editor 
                Interativo para cadastro de P&aacute;ginas Produtos da Empresa</strong></font></div></td>
          </tr>
          <tr> 
...
<p align="center"> 
              ...
              <table border="0" align="center" cellpadding="2" cellspacing="1">
                ...
                <tr>
                  <td align="right"><strong><font size="1" face="Verdana, Arial, Helvetica, sans-serif">T&iacute;tulo 
                    do Menu:</font></strong></td>
                  <td nowrap><font color="<%=cor_links%>" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                    <input name="tit_menu" type="text" 
			  value="<%=tit_menu%>" size="50">
                    </font></td>
                </tr>
                <tr> 
